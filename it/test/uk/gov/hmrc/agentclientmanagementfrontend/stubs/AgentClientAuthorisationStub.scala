...
trait AgentClientAuthorisationStub {
  ...
  def getInvitations(
    ...
    stubFor(
      get(urlEqualTo(s"/agent-client-authorisation/clients/$clientIdType/$clientId/invitations/received"))
        .willReturn(
          aResponse()
            .withStatus(200)
            .withBody(s"""
  ...
  def getVatInvitations(arns: Seq[Arn], clientId: String) = {
    val invitations = arns
      ...
      .mkString(",\r\n")
    stubFor(
      get(urlEqualTo(s"/agent-client-authorisation/clients/VRN/$clientId/invitations/received"))
        .willReturn(
          aResponse()
            .withStatus(200)
  ...
  def getAltItsaActiveRelationshipsNotFound(clientId: String): StubMapping =
    stubFor(
      get(urlEqualTo(s"/agent-client-authorisation/clients/MTDITID/$clientId/invitations/received"))
        .willReturn(
          aResponse()
            .withStatus(404)
        )
  ...
  def givenAgentRefExistsFor(arn: Arn): StubMapping =
    stubFor(
      get(urlEqualTo(s"/agencies/references/arn/${arn.value}"))
        .willReturn(
          aResponse()
            .withStatus(200)
            .withBody(
  ...
  def getAgencyNameMap200(arn: Arn, agencyName: String): StubMapping =
    stubFor(
      post(urlEqualTo(s"/agent-client-authorisation/client/agency-names"))
  ...
  def givenSuspensionDetails(arn: String, suspensionDetails: SuspensionDetails): StubMapping =
    stubFor(
      get(urlEqualTo(s"/agent-client-authorisation/client/suspension-details/$arn"))
        .willReturn(
          aResponse()
            .withStatus(200)
