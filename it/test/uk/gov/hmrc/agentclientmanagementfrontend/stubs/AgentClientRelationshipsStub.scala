...
trait AgentClientRelationshipsStub {
  ...
  def deleteActiveITSARelationship(arn: String, clientId: String, httpStatus: Int = 204): StubMapping =
    stubFor(
      delete(urlEqualTo(s"/agent-client-relationships/agent/$arn/service/HMRC-MTD-IT/client/MTDITID/$clientId"))
        .willReturn(
          aResponse()
  ...
  def deleteActiveVATRelationship(arn: String, clientId: String, httpStatus: Int = 204): StubMapping =
    stubFor(
      delete(urlEqualTo(s"/agent-client-relationships/agent/$arn/service/HMRC-MTD-VAT/client/VRN/$clientId"))
        .willReturn(
          aResponse()
            .withStatus(httpStatus)
        )
  ...
  def deleteActiveTrustRelationship(arn: String, clientId: String, httpStatus: Int = 204): StubMapping =
    stubFor(
      delete(urlEqualTo(s"/agent-client-relationships/agent/$arn/service/HMRC-TERS-ORG/client/SAUTR/$clientId"))
        .willReturn(
          aResponse()
            .withStatus(httpStatus)
        )
  ...
  def deleteActiveTrustNTRelationship(urn: String, clientId: String, httpStatus: Int = 204): StubMapping =
    stubFor(
      delete(urlEqualTo(s"/agent-client-relationships/agent/$urn/service/HMRC-TERSNT-ORG/client/URN/$clientId"))
        .willReturn(
          aResponse()
            .withStatus(httpStatus)
        )
  ...
  def deleteActivePptRelationship(arn: String, clientId: String, httpStatus: Int = 204): StubMapping =
    stubFor(
      delete(urlEqualTo(s"/agent-client-relationships/agent/$arn/service/HMRC-PPT-ORG/client/EtmpRegistrationNumber/$clientId"))
        .willReturn(
          aResponse()
            .withStatus(httpStatus)
        )
  ...
  def deleteActiveCbcRelationship(arn: String, clientId: String, isUKUser: Boolean, httpStatus: Int = 204): StubMapping = {
    ...
    stubFor(
      delete(urlEqualTo(s"/agent-client-relationships/agent/$arn/service/$service/client/cbcId/$clientId"))
        .willReturn(
          aResponse()
            .withStatus(httpStatus)
        )
  ...
  def deleteActivePlrRelationship(arn: String, clientId: String, httpStatus: Int = 204): StubMapping =
    stubFor(
      delete(urlEqualTo(s"/agent-client-relationships/agent/$arn/service/HMRC-PILLAR2-ORG/client/PLRID/$clientId"))
        .willReturn(
          aResponse()
            .withStatus(httpStatus)
        )
  ...
  def getClientActiveAgentRelationships(service: String, agentArn: String, startDate: String): StubMapping =
    stubFor(
      get(urlEqualTo(s"/agent-client-relationships/client/relationships/service/$service"))
        .willReturn(
          aResponse()
            .withStatus(200)
            .withBody(s"""
  ...
  def getInactiveClientRelationshipsEmpty(): StubMapping =
    stubFor(
      get(urlEqualTo(s"/agent-client-relationships/client/relationships/inactive"))
        .willReturn(
          aResponse()
            .withStatus(200)
            .withBody(
