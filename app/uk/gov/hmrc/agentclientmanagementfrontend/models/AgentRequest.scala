...
case class AgentRequest(clientType: String, serviceName: String, arn: Arn, uid: String, agencyName:String, status: String, expiryDate: LocalDate, lastUpdated: LocalDateTime, invitationId: String)
