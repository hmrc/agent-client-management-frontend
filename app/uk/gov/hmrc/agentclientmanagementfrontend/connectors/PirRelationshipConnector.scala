...
import uk.gov.hmrc.agentclientmanagementfrontend.util.{HttpAPIMonitor, Services}
...
@Singleton
class PirRelationshipConnector @Inject() (appConfig: AppConfig, http: HttpClient, val metrics: Metrics)(implicit val ec: ExecutionContext)
